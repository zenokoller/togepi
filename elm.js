...
var _user$project$Main$twoDigitString = function (d) {
	return A3(
...
var _user$project$Main$hoursMinutesSecondsString = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._0;
	var hourString = (_elm_lang$core$Native_Utils.cmp(_p2, 0) > 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Main$twoDigitString(_p2),
		':') : '';
	return A2(
		_elm_lang$core$Basics_ops['++'],
		hourString,
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Main$twoDigitString(_p1._1),
			A2(
				_elm_lang$core$Basics_ops['++'],
				':',
				_user$project$Main$twoDigitString(_p1._2))));
};
var _user$project$Main$hoursMinutesSeconds = function (s) {
	var h = (s / 3600) | 0;
	var m = ((s / 60) | 0) - (h * 60);
	return {
		ctor: '_Tuple3',
		_0: h,
		_1: m,
		_2: A2(_elm_lang$core$Basics_ops['%'], s, 60)
	};
};
var _user$project$Main$secondsToString = function (_p3) {
	return _user$project$Main$hoursMinutesSecondsString(
		_user$project$Main$hoursMinutesSeconds(_p3));
};
var _user$project$Main$timeFromSetting = function (_p4) {
	var _p5 = _p4;
	return ((_p5._0 * 3600) + (_p5._1 * 60)) + _p5._2;
};
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {timeSetting: a, time: b, timerState: c};
	});
var _user$project$Main$Editing = function (a) {
	return {ctor: 'Editing', _0: a};
};
var _user$project$Main$Ticking = {ctor: 'Ticking'};
var _user$project$Main$Paused = {ctor: 'Paused'};
var _user$project$Main$init = function () {
	var setting = {ctor: '_Tuple3', _0: 0, _1: 25, _2: 0};
	var t = _user$project$Main$timeFromSetting(setting);
	return {
		ctor: '_Tuple2',
		_0: {timeSetting: setting, time: t, timerState: _user$project$Main$Paused},
			...
			case 'SetHours':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							timeSetting: {ctor: '_Tuple3', _0: h, _1: m, _2: s},
							time: _user$project$Main$timeFromSetting(
								{ctor: '_Tuple3', _0: h, _1: m, _2: s}),
							timerState: _user$project$Main$Editing(true)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetMinutes':
				var _p8 = model.timeSetting;
				var h = _p8._0;
				var s = _p8._2;
				var m = A2(
					_elm_lang$core$Basics_ops['%'],
						...
						switch (_p10.ctor) {
							case 'Ticking':
								...
								switch (_p11.ctor) {
									case 'Tick':
										var s = model.time;
										var newState = (_elm_lang$core$Native_Utils.cmp(s, 1) > 0) ? _user$project$Main$Ticking : _user$project$Main$Paused;
										return _elm_lang$core$Native_Utils.update(
											model,
											{timerState: newState, time: s - 1});
									case 'Pause':
										return _elm_lang$core$Native_Utils.update(
											model,
											{timerState: _user$project$Main$Paused});
									case 'Reset':
										return _elm_lang$core$Native_Utils.update(
											model,
											{
							...
							case 'Paused':
								...
								switch (_p12.ctor) {
									case 'Start':
										return _elm_lang$core$Native_Utils.update(
											model,
											{timerState: _user$project$Main$Ticking});
									case 'Reset':
										return _elm_lang$core$Native_Utils.update(
											model,
											{
								...
								switch (_p13.ctor) {
									...
									case 'ValidationError':
										return _elm_lang$core$Native_Utils.update(
											model,
											{
												timerState: _user$project$Main$Editing(false)
											});
									default:
										return model;
								}
...
var _user$project$Main$ValidationError = {ctor: 'ValidationError'};
var _user$project$Main$SetSeconds = function (a) {
	return {ctor: 'SetSeconds', _0: a};
};
var _user$project$Main$SetMinutes = function (a) {
	return {ctor: 'SetMinutes', _0: a};
};
var _user$project$Main$SetHours = function (a) {
	return {ctor: 'SetHours', _0: a};
};
var _user$project$Main$timeView = function (model) {
	var _p14 = model.timerState;
	if (_p14.ctor === 'Editing') {
		var _p15 = model.timeSetting;
		var h = _p15._0;
		var m = _p15._1;
		var s = _p15._2;
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('00'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(
									_user$project$Main$twoDigitString(h)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetHours),
									_1: {ctor: '[]'}
								}
							}
						}
							...
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(
											_user$project$Main$twoDigitString(m)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetMinutes),
											_1: {ctor: '[]'}
										}
									}
								}
									...
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(
													_user$project$Main$twoDigitString(s)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SetSeconds),
													_1: {ctor: '[]'}
												}
											}
										}
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$Main$secondsToString(s)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
...
var _user$project$Main$startButton = function (model) {
	var _p16 = model.timerState;
	if (_p16.ctor === 'Ticking') {
		return A2(
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('timer-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A3(
				...
				'link',
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('bootstrap.min.css'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
							...
							_0: A2(
								_rundis$elm_bootstrap$Bootstrap_Grid$col,
								{
									...
									_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$attrs(
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('time-view'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _user$project$Main$timeView(model),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Main$startButton(model),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$subscriptions = function (model) {
	var _p17 = model.timerState;
	if (_p17.ctor === 'Ticking') {
